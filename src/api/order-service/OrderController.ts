...
export interface OrderVo {
  ...
  status: number; // 状态：0-待审核，1-已审核，2-部分完成，3-已完成，-1-已取消，-2-审批拒绝
...
export interface OrderQueryDto {
  ...
  status: number; // 状态：0-待审核，1-已审核，2-入库中，3-已完成，-1-已取消，-2-审批拒绝
...
export interface OrderInItem {
  ...
  status: number; // 状态：0-待开始，1-部分完成，2-已完成,-1-已取消，-2-审批拒绝
