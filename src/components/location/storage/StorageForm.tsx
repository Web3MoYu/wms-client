...
import { Storage } from '../../../api/location-service/StorageController';
...
const StorageForm: React.FC<StorageFormProps> = ({
  ...
  return (
    ...
    >
      ...
      <Form.Item
        name="shelfId"
        label={<Space><span style={{ color: '#ff4d4f' }}>*</span>所属货架</Space>}
      ...
      <Form.Item
        name="locationCode"
        label={<Space><span style={{ color: '#ff4d4f' }}>*</span>库位编码</Space>}
        rules={[
